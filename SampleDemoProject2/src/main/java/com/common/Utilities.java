...
public class Utilities implements IConstantValues{
...
public void sendKeys(WebElement element, String fieldValue) {
	...
	public void waitMethod(WebElement element) {
		WebDriverWait w = new WebDriverWait(BaseTest.driver, 10);
		w.until(ExpectedConditions.elementToBeClickable(element));
	}
	
	public void verifyText(WebElement element, String s) {
